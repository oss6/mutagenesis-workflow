...
def main():
    ...
    save_mutagenesis_data(args.output, 'initial', mutagenesis_data)
    print('Done.\n')
    ...
    if should_run_all or 'filter' in args.steps:
        ...
        save_mutagenesis_data(args.output, 'high_affinity', mutagenesis_data)
    ...
    if should_run_all or 'uniprot_enrich' in args.steps:
        ...
        save_mutagenesis_data(args.output, 'uniprot_info', mutagenesis_data)
        print('Done.\n')
    ...
    if should_run_all or 'residue_features' in args.steps:
        ...
        save_mutagenesis_data(args.output, 'residue_features', mutagenesis_data)
        print('Done.\n')
    ...
    if should_run_all or 'aa_props' in args.steps:
        ...
        save_mutagenesis_data(args.output, 'aa_props', mutagenesis_data)
        print('Done.\n')

    save_mutagenesis_data(args.output, 'summary', mutagenesis_data)
    save_mutagenesis_data(args.output, 'summary_neutral', n_mutagenesis_data)
